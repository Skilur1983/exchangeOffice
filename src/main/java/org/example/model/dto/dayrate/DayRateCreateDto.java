...
public class DayRateCreateDto {
    ...
    @FutureOrPresent(message = "Rate date cannot be in the past")
    ...
    @AssertTrue(message = "Base currency and quote currency must be different")
    public boolean isCurrencyPairValid() {
        if (baseCurrency == null || quoteCurrency == null) return true;
        return !baseCurrency.equals(quoteCurrency);
    }
}
