...
@Slf4j
@Component
public class BuyerCurrencyDealSpecification implements SpecificationProvider<Deal> {

    private static final String FILTER_KEY = "buyerCurrency";
    private static final String FIELD_NAME = "buyerCurrency";
    ...
    public Specification<Deal> getSpecification(String[] params) {
        ...
        try {
            ...
            log.debug("Creating specification for buyerCurrency: {}", currency);

            return (root, query, criteriaBuilder) ->
                    criteriaBuilder.equal(root.get(FIELD_NAME), currency);

        } catch (IllegalArgumentException e) {
            log.warn("Invalid buyerCurrency value: '{}'. Available currencies: {}",
